...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "figures" / "feature_selection" / "N2O"
...
print(f"N2O分位裁剪: 下界={lower:.4f}, 上界={upper:.4f}, 保留{len(y)}条, 移除{original_len - len(y)}条")
# ====== 结束 ======
