...
INPUT_FILE = PROJECT_ROOT / 'data' / 'figure_inputs' / 'CH4_map_values.xlsx'
OUTPUT_DIR = PROJECT_ROOT / 'outputs' / 'figures' / 'province_maps'
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_MAP = OUTPUT_DIR / 'CH4_map.html'
OUTPUT_PNG = OUTPUT_DIR / 'CH4_ranking.png'
OUTPUT_PDF = OUTPUT_DIR / 'CH4_ranking.pdf'
# ================================
