...
INPUT_FILE = PROJECT_ROOT / 'data' / 'figure_inputs' / 'TN_map_values.xlsx'
OUTPUT_DIR = PROJECT_ROOT / 'outputs' / 'figures' / 'province_maps'
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_MAP = OUTPUT_DIR / 'TN_map.html'
OUTPUT_PNG = OUTPUT_DIR / 'TN_ranking.png'
OUTPUT_PDF = OUTPUT_DIR / 'TN_ranking.pdf'
# ================================
