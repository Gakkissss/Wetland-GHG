...
TREATMENTS = ["Depth", "CN_in", "TN_in", "NH4_in"]
OUTCOME = "N2O"
...
def build_graph_dot():
    """构造基于领域知识的DAG(dot字符串)。"""
    # 用户指定的因果关系:
    # nodes = ['Depth', 'CN_in', 'TN_in', 'NH4_in', 'N2O']
    # edges = [
    #     ('TN_in', 'CN_in'), ('TN_in', 'N2O'), ('CN_in', 'N2O'),
    #     ('Depth', 'N2O'), ('NH4_in', 'CN_in'), ('NH4_in', 'TN_in'),
    #     ('NH4_in', 'N2O')
    # ]
    edges_str = "; ".join([
        'TN_in -> CN_in',
