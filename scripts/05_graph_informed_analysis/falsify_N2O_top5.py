# -*- coding: utf-8 -*-
# @Time    : 2025/10/22 16:57
# @Author  : 55050
# @File    : falsify_N2O_top5.py
# @Software: PyCharm
...
_causal_cols = ['Depth', 'CN_in', 'TN_in', 'NH4_in', 'TN_re', 'N2O']
...
df_causally = df[['Depth', 'CN_in', 'TN_in', 'NH4_in', 'TN_re', 'N2O']]
df_causally
...
# 手动定义因果图的节点和边
nodes = ['Depth', 'CN_in', 'TN_in', 'NH4_in', 'TN_re', 'N2O']
edges = [
    ('TN_in', 'CN_in'),
    ('TN_in', 'TN_re'),
    ('TN_re', 'N2O'),
