...
_causal_cols = ['COD_in', 'HRT', 'Depth', 'Water_Temperature', 'HLR', 'CH4']
...
df_causally = df[['COD_in', 'HRT', 'Depth', 'Water_Temperature', 'HLR', 'CH4']]
df_causally
...
# 手动定义因果图的节点和边
nodes = ['COD_in', 'HRT', 'Depth', 'Water_Temperature', 'HLR', 'CH4']
edges = [
    ('COD_in', 'CH4'),
    ('COD_in', 'HRT'),
    ('HRT', 'CH4'),
    ('Depth', 'HRT'),
    ('Water_Temperature', 'CH4'),
    ('HLR', 'HRT')
